  ...
  return (
    <div className='mx-auto container xl:px-20 lg:px-12 sm:px-6 px-4 px-4 py-12'>
      <div className='flex flex-col items-center justify-center'>
        ...
        <div className='hidden sm:flex flex-row items-center space-x-6 mt-5 mb-2'>
          <svg
        ...
        <div className='flex items-center mt-6'>
          <p className='text-base leading-4 text-gray-800'>
            2021 <span className='font-semibold'>Prathmesh Sadake</span>
          </p>
          <div className='border-l border-gray-800 pl-2 ml-2'>
            <p className='text-base leading-4 text-gray-800'>
              Made with 🖤 by Prathmesh Sadake
            </p>
          </div>
        </div>
      </div>
